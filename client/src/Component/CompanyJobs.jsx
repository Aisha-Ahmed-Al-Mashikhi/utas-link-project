...
const CompanyJobs = () => {
  ...
  // Filters jobs based on the search
  ...
  // Slice jobs for current page (Using filteredJobs to avoid empty pages during search)
  ...
  return (
    ...
    <div className="companyjobs-page">
      ...
      <div className="companyjobs-wrapper">
        ...
        {/* --- NEW SEARCH BAR UI --- */}
        {/* Matching FindJob style structure */}
        ...
        {showModal && (
          <div className="overlay">
            <div className="edit-modal">
              ...
              {/* ADDED DURATION INPUT IN EDIT MODAL */}
              <label>Job Expiry (Days)</label>
              <input
                type="number"
                value={editedJob.postDuration}
                onChange={(e) =>
                  setEditedJob({ ...editedJob, postDuration: e.target.value })
                }
              />
